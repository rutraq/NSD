...
begin
  Memo1.Clear;
  Memo1.Lines.Add('При шифровании файла, ваш файл изменит расширение на .A&Y, а при расшифровании он изменит своё расширение на исходное, так что менять расширение вручную нельзя.');
end;
